...
/**
 * Server-side read/write path for the `published` document.
 *
 ...
 * this file exactly, differing only in the DataKind. app/api/local/vendors
 * differs additionally in its array key ("vendors") and its lighter
 * validation -- see its own header.
 */
